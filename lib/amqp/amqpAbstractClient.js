...
const retryDelayTimeoutIncrement = 5 * 1000
const retryMaxDelayTimeout = 60 * 1000

const retryUntilSuccess = async function retryUntilSuccess (asyncFunction, args, delay) {
  let delayTimeout = delay || 0
  if (delayTimeout > retryMaxDelayTimeout) {
    delayTimeout = retryDelayTimeoutIncrement
  }
  try {
    ...
    return retryUntilSuccess(asyncFunction, args, delayTimeout + retryDelayTimeoutIncrement)
  }
}
